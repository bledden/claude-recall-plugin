...
- `sessions` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/manage_sessions.py list $RECALL_PROJECT_HASH`
...
- `tag <name>` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/manage_tags.py add <name> $RECALL_SESSION_ID`
- `tag <name> #<exchange>` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/manage_tags.py add <name> $RECALL_SESSION_ID <exchange>`
- `tags` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/manage_tags.py list --project $RECALL_PROJECT_HASH`
...
!`python3 ${CLAUDE_PLUGIN_ROOT}/scripts/show_index.py --session $RECALL_SESSION_ID`
...
### If "Recent (last 5)":
Run: `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID last5`

### If "Search by keyword":
1. Ask for the keyword using AskUserQuestion
2. Run: `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID search <keyword>`
...
2. Run: `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID around <time>`
...
**Examples:**
- `/recall last5` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID last5`
- `/recall last10` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID last10`
- `/recall around 2pm` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID around 2pm`
- `/recall search auth` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/fetch_exchanges.py --session $RECALL_SESSION_ID search auth`
- `/recall sessions` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/manage_sessions.py list $RECALL_PROJECT_HASH`
- `/recall tags` → `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/manage_tags.py list --project $RECALL_PROJECT_HASH`
